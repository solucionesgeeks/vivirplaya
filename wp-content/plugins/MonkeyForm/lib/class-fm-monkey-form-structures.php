 ...
 */
if ( !class_exists( 'Monkey_Form_Structure' ) ) :
	class Monkey_Form_Structure {
		...
		public static function instance() {
			if ( ! isset( self::$instance ) ) {
				self::$instance = new Monkey_Form_Structure;
				self::$instance->setup();
			}
	...
	function Monkey_Form_Structure() {
		return Monkey_Form_Structure::instance();
	}
endif;