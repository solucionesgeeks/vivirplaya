 ...
 */
if ( !class_exists( 'Monkey_Service_Structure' ) ) :
	class Monkey_Service_Structure {
		...
		public static function instance() {
			if ( ! isset( self::$instance ) ) {
				self::$instance = new Monkey_Service_Structure;
				self::$instance->setup();
			}
	...
	function Monkey_Service_Structure() {
		return Monkey_Service_Structure::instance();
	}
endif;