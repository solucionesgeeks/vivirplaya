 ...
 */
if ( !class_exists( 'Monkey_Slide_Structure' ) ) :
	class Monkey_Slide_Structure {
		...
		public static function instance() {
			if ( ! isset( self::$instance ) ) {
				self::$instance = new Monkey_Slide_Structure;
				self::$instance->setup();
			}
	...
	function Monkey_Slide_Structure() {
		return Monkey_Slide_Structure::instance();
	}
endif;